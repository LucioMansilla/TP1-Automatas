...
int main(int argc, char *argv[]) {
    ...
    Transition transitions[] = {
        create_transition(0, 0, create_from((int[]){1, 2}, 2)), create_transition(0, 47, create_from((int[]){1}, 1)),
        create_transition(1, 1, create_from((int[]){2}, 1)),    create_transition(2, 0, create_from((int[]){2}, 1)),
        create_transition(2, 1, create_from((int[]){2}, 1)),    {-1, -1, NULL} // sentinel element
    };
